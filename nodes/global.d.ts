import type {Snapshot} from "../types/meta.ts";
import type {ContextData} from "../types/context.ts";
...
declare global {
  ...
  interface QGraph extends HTMLElement {
    ...
    viewport: QViewport
    addAtom(snapshot: Snapshot<any, any, any>): Promise<QGraphAtom & HTMLElement>
    handlePatch(patch: { op: string; path: string; value: any }): Promise<void>
    updateContext(atom: HTMLElement, context: ContextData<any>): void
