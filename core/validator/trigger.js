...
/**
 ...
 @param {import('types/transitions.js').Transitions<any,any, any>} params.transitions Массив переходов
 @param {import('types/context.js').ContextDefinition} params.contextDefinition Определение контекста
 */
...
/**
 ...
 @param {import('types/context.js').TypeDefinition} definition Тип поля
...
/**
 ...
 @param {string} field - Название поля
 @param {any} value - Значение триггера
 @param {import('types/context.js').TypeDefinition} definition - Определение типа
 @throws {Error} Если триггер некорректен
 */
...
/**
 ...
 @param {string} field - Название поля
 @param {import('types/context.js').EnumDefinition<any>} definition - Тип поля
 @param {any} value - Значение триггера
 @throws {Error} Если триггер некорректен
 */
