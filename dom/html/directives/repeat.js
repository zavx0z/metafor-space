...
/** @type {import("./repeat.js").generateMap} */
...
class RepeatDirective extends Directive {
     ...
     * @param {import("./repeat").keyFnOrTemplate<T>} keyFnOrTemplate
     * @param {import("./repeat").ItemTemplate<T>} [template]
     * @return {{values: unknown[], keys: unknown[]}}
     */
     ...
     * @param {[Iterable<T>, import("./repeat").KeyFn<T> | import("./repeat").ItemTemplate<T>,import("./repeat").ItemTemplate<T>]} args
     */
    update(containerPart, [items, keyFnOrTemplate, template]) {
        ...
        // массив для обработки массивов @metafor/html для рендеринга и запоминаем
        // ключи.
