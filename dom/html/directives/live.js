 ...
 *
 * Это полезно для случаев, когда значение DOM может изменяться извне @metafor/html,
 ...
 * через привязки @metafor/html, не изменяется, @metafor/html не узнает о необходимости
