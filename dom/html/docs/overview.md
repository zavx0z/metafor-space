...
Вы также можете использовать библиотеку шаблонов @metafor/html для автономной шаблонизации, вне MetaFor. Подробности см. в разделе [Автономные шаблоны @metafor/html](./standalone-templates.md).
